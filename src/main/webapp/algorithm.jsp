...
<%!
    class KeyGeneration
    {
        ...
        void GenerateKeys(String inputkey ) throws IOException {
            int[] key = new int[10];
	/*
    int temp;
    for(int i=9;i>=0;i--)
    ...
    */
        ...
        public int[] getK1() throws IOException {
            if(!flag)
            {
        ...
        public int[] getK2() throws IOException {
            if(!flag)
            {
               // out.print("\nError Occured: Keys are not generated yet ");
                return null;
    ...
    class Encryption
    {
        ...
        void SaveParameters(String plaintext , int[] k1, int[] k2) throws IOException {
            int[] pt = new int[8];
    ...
    */
        ...
        int[] encrypt(String plaintext , int[] LK, int[] RK) throws IOException {
            try {
    ...
    public class Decryption_algo
    {
        ...
        public int[] decrypt(String ciphertext, String key) throws IOException {
            ...
            {
                KG.GenerateKeys(key);
                ct = enc.encrypt( ciphertext ,KG.getK2(),KG.getK1());
            }
    ...
    public class Encryption_algo
    {
        ...
        public int[] encrypt(String plaintext,String key) throws IOException {
            ...
            try
            {
                ...
                //Ex Input : 1010000010
                KG.GenerateKeys(key);
                ct = enc.encrypt( plaintext ,KG.getK1(),KG.getK2());
            }
            catch(InputMismatchException e)
            {
                //out.print("-- Error Occured : Invalid Input ");
            }
            catch(Exception e)
            {
